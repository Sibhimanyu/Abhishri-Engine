                ...
                <div class="profile-card-main" style="margin-top: 0; border-radius: 24px;">
                    <div class="metrics-grid">
                        ...
                        <div class="metric-card">
                            ...
                            <div class="metric-info"><h3>Wallet Balance</h3><div class="metric-value" style="color:${canViewFees ? (balance >= 0 ? 'var(--success)' : 'var(--accent-primary)') : 'var(--text-dim)'}">${canViewFees ? `₹${balance.toLocaleString('en-IN')}` : 'No Access'}</div></div>
                        </div>
                        <div class="metric-card">
