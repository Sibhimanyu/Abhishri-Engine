...
export default function PaymentReceipt({ receiptTransaction, student, wing, components, onClose, onPrint }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center p-4 bg-black/80 backdrop-blur-sm overflow-y-auto print:bg-white print:p-0 print:absolute">
      <div className="bg-white text-black border border-gray-200 rounded-none md:rounded-2xl shadow-2xl w-full max-w-2xl my-8 print:my-0 print:shadow-none print:border-none print:max-w-none print:w-full">
        ...
        <div className="p-8 md:p-12 bg-white print:p-0">
          ...
          <div className="grid grid-cols-2 gap-8 mb-10">
            <div>
              ...
              <p className="text-sm text-gray-500">Class/Wing: <span className="capitalize">{wing || 'Preschool'}</span></p>
            </div>
            <div className="text-right">
          ...
          <div className="text-center pt-8 border-t-2 border-gray-100 text-gray-500 text-xs">
            ...
            <p className="mt-1">Processed by: {receiptTransaction.addedBy || 'System'}</p>
          </div>
        </div>
      </div>
      ...
      <style dangerouslySetInnerHTML={{__html: `
        @media print {
          ...
          .print\\:absolute { position: absolute !important; left: 0; top: 0; }
